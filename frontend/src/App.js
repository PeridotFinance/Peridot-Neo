...
const PeridotSwapContainer = lazy(() => import("./components/content/peridotSwap/PeridotSwapContainer.js"));
const IFOContainer = lazy(() => import("./components/content/ifo/IFOContainer.js"));
const InventoryContainer = lazy(() => import("./components/content/inventory/InventoryContainer.js"));
		...
		<BrowserRouter>
			<Suspense fallback={<LoadingSpinnerPage/>}>
				<Routes>
					...
					<Route exact path="/peridot-swap" element={<PeridotSwapContainer/>}/>
